...
: ${AMENT_CURRENT_PREFIX:="/gapFinder_ws/install/gap_finder"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gap_finder/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gap_finder/environment/path.sh"
